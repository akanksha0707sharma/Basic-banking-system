...
<body>
    ...
    <div class="center mt-0 #C0C0C0 grey accent-3">
        <h3><b><span><img src="https://th.bing.com/th?q=CB+Logo+Font&w=120&h=120&c=1&rs=1&qlt=90&cb=1&dpr=1.25&pid=InlineBlock&mkt=en-IN&adlt=moderate&t=1&mw=247" style="height:60px;width:50px" /></span>Few Steps To Go...</b></h3>
    </div>
    <div class="container-fluid">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <div class="text-center">
                <button style="color:red" name="submit" type="submit" id="myBtn" >Transfer</button>
            </div>
            <br>
        </form>
    </div>
